...
1. [ASPIRE](https://github.com/PrincetonUniversity/aspire) — Python package for a comprehensive cryo-EM image precessing and 3-D reconstruction.
...
4. [FINUFFT](https://finufft.readthedocs.io/en/latest/) — Nonuniform fast Fourier transform (NUFFT) library.
...
The synthetic datasets can also be downloaded from [https://zenodo.org/records/15815808].
