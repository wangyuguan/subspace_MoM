...
if __name__ == "__main__":
    ...
    tol2 = 1e-4 
    out_file_name = 'second_moment_analytical_test_4.npz'
    run_second_moment_analytical_test(vol_path, tol2, out_file_name)

    tol2 = 1e-6
    out_file_name = 'second_moment_analytical_test_6.npz'
    run_second_moment_analytical_test(vol_path, tol2, out_file_name)

    tol2 = 1e-8 
    out_file_name = 'second_moment_analytical_test_8.npz'
    run_second_moment_analytical_test(vol_path, tol2, out_file_name)

    tol2 = 1e-10 
    out_file_name = 'second_moment_analytical_test_10.npz'
    run_second_moment_analytical_test(vol_path, tol2, out_file_name)

    tol2 = 1e-12
    out_file_name = 'second_moment_analytical_test_12.npz'
    run_second_moment_analytical_test(vol_path, tol2, out_file_name)

    tol2 = 1e-14
    out_file_name = 'second_moment_analytical_test_14.npz'
    run_second_moment_analytical_test(vol_path, tol2, out_file_name)